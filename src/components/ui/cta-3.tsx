...
export function CallToAction() {
  return (
    <div className="relative mx-auto flex w-full max-w-4xl flex-col justify-between gap-y-6 border-y bg-[radial-gradient(35%_80%_at_25%_0%,--theme(--color-foreground/.08),transparent)] px-4 py-24">
      <PlusIcon
      ...
      <div className="space-y-1">
        ...
        <p className="text-center text-muted-foreground">
          Create your first gateway in under 5 minutes. No credit card required.
        </p>
      </div>
